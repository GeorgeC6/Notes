...
-   曲面 $d\vec{S}$
    ...
    - 通量
      ...
      $$
      \oiint_S \vec{E} \cdot d\vec{S} = \frac{Q_S}{\epsilon_0}
      $$
...
!!! note "Stokes 定理（广义）"
    ...
    -   $k = 1$ 时
        ...
        $$
        \oint_{\partial S} \vec{E} \cdot d\vec{l} = \int_S \left(\nabla \times \vec{E}\right) \cdot d\vec{S}
        $$
        ...
        $$
        \mathrm{d}^2 = \sum_i dx_i \wedge \frac{\partial}{\partial x_i} \sum_j dx_j \wedge \frac{\partial}{\partial x_j} = 0
        $$
    ...
    -   $k = 2$ 时
        ...
        $$
        \int_{\partial V} \vec{E} \cdot d\vec{S} = \int_V \left(\nabla \cdot \vec{E}\right) dV
        $$
